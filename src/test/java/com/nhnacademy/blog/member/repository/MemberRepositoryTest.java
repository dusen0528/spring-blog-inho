...
class MemberRepositoryTest {
    ...
    void findFromCache(){
        ...
        Optional<Member> cachedMember = memberRepository.findById(member.getMbNo());
         ...
         */
        Optional<Member> member2Optional = memberRepository.findById(member.getMbNo());
        log.debug("after clear(): {}", member2Optional.get());

        /**
         * member2 entity를 검증하세요
         */
        Assertions.assertTrue(member2Optional.isPresent());
        Assertions.assertAll(
                ()->{
                    Assertions.assertEquals(member.getMbNo(), member2Optional.get().getMbNo());
                    Assertions.assertEquals("마르코",  member2Optional.get().getMbName());
                    Assertions.assertEquals("marco@nhnacademy.com",  member2Optional.get().getMbEmail());
                    Assertions.assertEquals("12345",  member2Optional.get().getMbPassword());
                }
        );
    ...
    void updateTest(){
        ...
        Assertions.assertAll(
                ()->{
                    Assertions.assertEquals(member.getMbNo(), member2Optional.get().getMbNo());
                    Assertions.assertEquals("테스트", member2Optional.get().getMbName());
                    Assertions.assertEquals("test@nhnacademy.com", member2Optional.get().getMbEmail());
                    Assertions.assertEquals("changePassword", member2Optional.get().getMbPassword());
                }
        );
    }
    ...
    void deleteTest(){
        ...
        Optional<Member> deletTargetOptional = memberRepository.findById(member.getMbNo());
         ...
         */
        memberRepository.delete(deletTargetOptional.get());
        // or memberRepository.deleteById(deletTargetOptional.get().getMbNo());
    ...
    void detachTest(){
        ...
        // member entity를 조회 합니다.
        Optional<Member> member2Optional = memberRepository.findById(member.getMbNo());
        log.debug("member: {}", member2Optional.get());
        ...
        Assertions.assertAll(
                ...
                ()->{
                    Assertions.assertEquals("01012345678", member2Optional.get().getMbMobile());
                }
        );
    }
    ...
    void margeTest(){
        ...
        Assertions.assertAll(
                ...
                ()->{
                    Assertions.assertEquals("01011112222", member2Optional.get().getMbMobile());
                }
        );
    }
}